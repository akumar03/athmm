...
# Date: 1/4/2010
# Description: This program runs the beta mutation experiment with 10-100% mutations and 0-25% simple mutations and prints roc
...
#adding beta mutated sequences
    ...
    my $com = "/cluster/tufts/protein/se2/hmmer/hmmer-3.0a2/src/hmmbuild ".$exp_class.".hmm ".$exp_class.".ssi";
        print "$com\n";
    print `$com`;
